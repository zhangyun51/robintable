                            ...
                            for (i in response) {
                                ...
                                for (col in colOptions) {
                                    ...
                                    if (colOptions[col].type === 'number') {
                                        var data = $.fn.RobinTable.numberFormat(response[i][colOptions[col].id], colOptions[col].format);
                                    } else {
                                        data = response[i][colOptions[col].id];
                                    }

                                    $("<td class='{clazz}'>{data}</td>".format({
